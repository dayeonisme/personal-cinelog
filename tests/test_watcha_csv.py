...
def test_derive_collection_url_from_profile_url():
    profile = "https://pedia.watcha.com/ko-KR/users/ZBm5RJM945d46/contents/movies"

    assert derive_collection_url(profile, "ratings") == (
        "https://pedia.watcha.com/ko-KR/users/ZBm5RJM945d46/contents/movies/ratings"
    )
    assert derive_collection_url(profile, "wishes") == (
        "https://pedia.watcha.com/ko-KR/users/ZBm5RJM945d46/contents/movies/wishes"
    )
